    ...
    <section className="py-12 sm:py-16 lg:py-20 z-20 relative bg-[url('/Images/home/ServiceSection.png')] bg-no-repeat bg-center bg-cover 2xl:px-80 lg:px-40 md:px-10 px-2">
      <div className="flex flex-col gap-20">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 ">
          {arr.map((_, index) => (
            <div className={`flex flex-col gap-3 2xl:pr-60 lg:pr-32 pr-2 lg:pl-10 pl-2 py-6 ${index % 2 ? "lg:border-l border-0 border-gray-300" : ""} ${index < arr.length - 2 ? "border-b border-gray-300" : ""}`} key={index}>
