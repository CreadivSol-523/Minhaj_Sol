...
import bulb from "../../../public/home/bulb.png"
...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <nav className="hidden lg:flex space-x-6 xl:space-x-8">
                            <a href="#" className="text-sm text-gray-700 hover:text-blue-600 transition">Home</a>
                            <a href="#" className="text-sm text-gray-700 hover:text-blue-600 transition">About</a>
                            <a href="#" className="text-sm text-gray-700 hover:text-blue-600 transition">Services</a>
                            <a href="#" className="text-sm text-gray-700 hover:text-blue-600 transition">Resources ▼</a>
                            <a href="#" className="text-sm text-gray-700 hover:text-blue-600 transition">Careers</a>
                        </nav>
                        <button className="bg-blue-600 text-white px-4 sm:px-6 py-2 rounded text-sm hover:bg-blue-700 transition">
                            Contact
                        </button>
                    </div>
                </div>
            ...
            {/* Hero Section */}
            {/* <section className="relative bg-gradient-to-br from-blue-50 via-white to-blue-50 py-12 sm:py-16 lg:py-24 h-[80vh] flex items-center overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative">
                        <div className="text-center lg:text-left">
                            ...
                            <div className="flex items-center border-l-2 border-[#186DBF] ps-4 mb-6 sm:mb-8 max-w-xl mx-auto lg:mx-0">
                                <p className="text-sm sm:text-base lg:text-lg text-gray-600">
                                    Empowering businesses worldwide with cutting-edge technology solutions.
                                    We help transform your digital presence and accelerate growth.
                                </p>
                            </div>
                            <button className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded hover:bg-blue-700 transition text-sm sm:text-base">
                                Learn More →
                            </button>
                        </div>
                        <div className="flex justify-center lg:justify-end absolute right-[-750px] top-[-850px] hidden lg:block">
                            <Image
                                src={bulb}
            ...
            <section className="relative bg-gradient-to-br from-[#FFFDF5] via-[#FFF9E7] to-[#FFFDF5] py-24 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center relative z-10">

                    {/* LEFT CONTENT */}
                    <div className="pt-10">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0F1D37] leading-tight mb-8">
                            We Provide <br />
                            Smart Business <br />
                            Solutions
                        </h1>
                        ...
                        <div className="flex gap-4 mb-10">
                            ...
                            <p className="text-[#1E2A3B] text-lg max-w-xl">
                                Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium
                                doloremque laudantium totam rem aperiam eaque ab illo inventore.
                            </p>
                        </div>

                        <button className="bg-[#186DBF] text-white px-8 py-3 rounded-md hover:bg-blue-700 transition">
                            Get In Touch
                        </button>
                    </div>
                </div>
                ...
                {/* RIGHT BULB IMAGE */}
                <div className="absolute bottom-0 right-0 w-[600px] lg:w-[700px] xl:w-[800px] pointer-events-none">
                    <Image
                        src={bulb}
                        alt="Bulb"
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-white">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 text-center mb-8 sm:mb-12 leading-tight">
                        Empowering Our Worldwide Clients To Adopt<br className="hidden sm:block" />
                        Cutting-Edge Technology, Reimagine<br className="hidden sm:block" />
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-16">
                        <ServiceCard
                            ...
                            description="Reach global audiences with data-driven marketing strategies tailored to your business needs."
                        />
                        <ServiceCard
                            title="LEADERSHIP"
                            description="Develop strong leadership capabilities through comprehensive training and coaching programs."
                        />
                        <ServiceCard
                            title="WEB DEVELOPMENT"
                            description="Build modern, responsive websites that deliver exceptional user experiences and drive results."
                        />
                        <ServiceCard
                            title="DATA ONLINE TRAINING"
                            description="Upskill your team with cutting-edge online training programs in data science and analytics."
                        />
                        <ServiceCard
                            title="AGILE + DEVOPS"
                            description="Streamline development with agile methodologies and DevOps best practices for faster delivery."
                        />
                        <ServiceCard
                            title="PRIVACY DESIGN BY OPERATION"
                            description="Build privacy and security into every aspect of your operations from the ground up."
                        />
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-xl sm:text-2xl lg:text-3xl text-center text-blue-600 font-semibold mb-12 sm:mb-16">
                        Into A Beneficial Asset
                    </p>
                    ...
                    <p className="text-sm sm:text-base text-gray-600 text-center max-w-4xl mx-auto leading-relaxed">
                        We deliver cutting-edge solutions that transform businesses. Our experienced team combines
                        technical expertise with strategic thinking to help organizations achieve their digital
                        transformation goals. With proven methodologies and innovative approaches, we ensure success
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        <WorkCard
                            ...
                            title="DEVELOPERS"
                            description="Skilled engineers building robust solutions"
                        />
                        <WorkCard
                            image="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=600"
                            title="DESIGNERS"
                            description="Creative professionals crafting beautiful experiences"
                        />
                        <WorkCard
                            image="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600"
                            title="CONSULTANTS"
                            description="Strategic advisors aligning technology with business"
                        />
                    </div>
                </div>
            </section>
            ...
            <section className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-block bg-orange-500 text-white text-xs sm:text-sm px-3 sm:px-4 py-1 rounded-full mb-4 sm:mb-6">
                        GET IN TOUCH
                    </div>
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 leading-tight">
                        Be On The Top & Reach<br className="hidden sm:block" />
                        Out To More People!
                    </h2>
                    <p className="text-sm sm:text-base lg:text-lg text-blue-100 mb-6 sm:mb-8 max-w-2xl mx-auto">
                        Ready to transform your business? Let's discuss how our solutions can help you achieve
                        your goals and reach new heights in the digital landscape.
                    </p>
                    <button className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded hover:bg-blue-700 transition text-sm sm:text-base font-medium shadow-lg">
                        Contact Us Today
                    </button>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                        <div>
                            ...
                            <p className="text-xs sm:text-sm text-gray-400 mb-4">
                                Providing innovative business solutions for the digital age.
                            </p>
                        ...
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 sm:px-4 py-2 bg-gray-800 text-white text-xs sm:text-sm rounded border border-gray-700 focus:outline-none focus:border-blue-500"
                                />
                                <button className="bg-blue-600 text-white px-4 sm:px-6 py-2 rounded hover:bg-blue-700 transition text-xs sm:text-sm whitespace-nowrap">
                                    Sign Up
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8 text-center">
                        <p className="text-xs sm:text-sm text-gray-400">
                            © 2024 MSS Solutions. All rights reserved. | Privacy Policy | Terms of Service
                        </p>
                    </div>
                </div>
            </footer>
